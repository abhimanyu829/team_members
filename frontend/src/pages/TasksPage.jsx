        ...
        <div className="fixed inset-0 bg-black/40 z-40 flex items-start justify-end p-4" onClick={(e) => { if (e.target === e.currentTarget) setSelectedTask(null); }}>
          <div className="bg-white rounded-2xl w-full max-w-md h-full overflow-y-auto shadow-xl p-6 flex flex-col">
            <div className="flex items-center justify-between mb-4">
              ...
              <button aria-label="Close task details" title="Close task details" onClick={() => setSelectedTask(null)} className="p-1 rounded-lg hover:bg-zinc-100">
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 shadow-xl">
            <div className="flex items-center justify-between mb-5">
              ...
              <button aria-label="Close create task modal" title="Close" onClick={() => setShowCreate(false)} className="p-1 rounded-lg hover:bg-zinc-100"><X className="w-4 h-4 text-zinc-400" /></button>
            </div>
